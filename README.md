...
![ID](Images/12.png)
4) Для отправления запроса Алисе воспользуемся [Online rest client](http://client.restcase.com)
5) Заполняем поля запроса:
![Request](Images/15.png)
![Request](Images/16.png)
6) В ответ на ваш запрос Алиса пришлет `Json`, содержащий `идентификатор изображения`:
